...
SOURCES = main.cpp BinaryHeap.cpp MethodOne.cpp MedianTester.cpp MethodThree.cpp MethodFour.cpp MethodFive.cpp MethodSix.cpp InputParser.cpp MethodControl.cpp
